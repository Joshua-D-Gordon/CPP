...
Team2::Team2(Character* theLeader): leader(theLeader){
...
void attack(std::nullptr_t){
    throw invalid_argument("cant attack nullptr");
}
...
void Team2::attack(Team2* otherTeam){
    if(otherTeam == nullptr){
        throw invalid_argument("other team can not be null");
    }
    if(!this->leader->isAlive()){
...
void Team2::attack(SmartTeam* otherTeam){
    if(otherTeam == nullptr){
        throw invalid_argument("other team can not be null");
    }
    if(!this->leader->isAlive()){
...
void Team2::changeLeader(Character* leader){
...
Character* Team2::chooseVictim(Team* otherTeam){
    double dis = -1;
...
Character* Team2::chooseVictim(Team2* otherTeam){
    double dis = -1;
    Character* firstelement = nullptr;
...
Character* Team2::chooseVictim(SmartTeam* otherTeam){
    double dis = -1;
    Character* firstelement = nullptr;
